...
// create
animalRouter.get('/animals', AnimalSearchController.handle);

// create
animalRouter.post('/animals', AnimalsCreateController.handle);

// Retrieve a single animal by ID
animalRouter.get('/animals/:animalID', AnimalsRetrieveController.handle);

// Update an animal by ID
animalRouter.put('/animals/:animalID', updateAnimalController.handle);
